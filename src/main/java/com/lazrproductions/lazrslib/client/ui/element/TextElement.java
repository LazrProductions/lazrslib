...
public class TextElement extends AbstractElement {
    final List<Component> text;
            ...
            public TextElement(@Nonnull Minecraft instance, @Nonnull Component text, int height, int color, boolean renderShadow) {
                super(instance, height);
                this.text = List.of(text);
                this.color = color;
            ...
            public TextElement(@Nonnull Minecraft instance, int width, @Nonnull Component text, int color) {
                super(instance, instance.font.wordWrapHeight(text.getContents(), width));
                this.text = List.of(text);
                this.color = color;
                this.renderShadow = true;
            }
            ...
            public TextElement(@Nonnull Minecraft instance, int width, @Nonnull List<Component> text, int color, boolean renderShadow) {
                super(instance, ComponentUtilities.getTotalHeight(instance, text, width));
                this.text = text;
                this.color = color;
                this.renderShadow = renderShadow;
