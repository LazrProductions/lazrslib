...
public class TagUtilities {
    ...
    public static NonNullList<ItemStack> itemStackFromTag(ListTag tag, HolderLookup.Provider registries) {
    ...
    public static ListTag itemStackToTag(NonNullList<ItemStack> items, HolderLookup.Provider registries) {
