...
public interface ILazrConfig{
     ...
     */
    <T> IConfigProperty<T> createGenericProperty(@Nonnull IConfigProperty<T> property);
     ...
     */
    IConfigCategory createCategory(@Nonnull IConfigCategory category, ICreatePropertiesFunction createProperties);
