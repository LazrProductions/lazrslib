...
import com.lazrproductions.lazrslib.common.network.packet.LazrPacket;

import net.minecraft.network.FriendlyByteBuf;
import org.jetbrains.annotations.NotNull;

public class LazrNetworkedParameterHandler {
    public static final <T extends LazrPacket> void writePacketParameters(Object[] parameters,
    ...
    public static final <T extends LazrPacket> void readPacket(T packet, FriendlyByteBuf buffer) {
    ...
    static final byte[] serialize(@NotNull Object obj) {
    ...
    static final Object deserialize(byte[] bytes) {
        ...
        try (ObjectInput in = new ObjectInputStream(bis)) {
            ...
            LazrsLibConstants.LOG.error(e.getMessage(), e);
            throw e;
        }
    }
}