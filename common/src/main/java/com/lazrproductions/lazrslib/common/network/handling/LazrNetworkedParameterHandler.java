...
public class LazrNetworkedParameterHandler {
    public static void writePacketParameters(Object[] parameters, FriendlyByteBuf buffer) {
        buffer.writeInt(parameters.length);
        for (Object p : parameters)
            buffer.writeByteArray(serialize(p));
    }

    public static <T extends LazrPacket> void readPacket(T packet, FriendlyByteBuf buffer) {
