...
public class FontUtilities {
     ...
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull List<Component> list, int color) {
     ...
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull List<Component> list, int color, boolean renderShadow) {
        int space = 15;
        int width = 0;
     ...
     * @param color The color of the drawn text.
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull List<Component> list, int color) {
     ...
     * @param renderShadow Whether to draw the text's drop shadow.
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull List<Component> list, int color, boolean renderShadow) {
     ...
     * @param color The color of the drawn text.
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, String text, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color) {
     ...
     * @param renderShadow Whether to draw the text's drop shadow.
     */
    public static void renderLabel(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, boolean renderShadow) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull String text, int maxWidth, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color) {
     ...
     * @param renderShadow Whether to draw the text's drop shadow.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, boolean renderShadow) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull Component component, int maxWidth, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color) {
     ...
     * @param renderShadow Whether to draw the text's drop shadow.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color, boolean renderShadow) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull List<Component> list, int maxWidth, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull List<Component> list, int color) {
     ...
     * @param renderShadow Whether to draw the text's drop shadow.
     */
    public static void drawParagraph(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull List<Component> list, int color, boolean renderShadow) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawText(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull String text, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawText(@NotNull Font font, @NotNull GuiGraphics graphics, int x, int y, @NotNull Component component, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawText(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color) {
     ...
     * @param color The color of the drawn text.
     */
    public static void drawText(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color) {
     ...
     */
    public static boolean drawLink(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, int highlightedColor, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLink(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, int highlightedColor, boolean renderShadow, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLink(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color, int highlightedColor, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLink(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color, int highlightedColor, boolean renderShadow, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLinkWrapped(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, int highlightedColor, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLinkWrapped(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull String text, int color, int highlightedColor, boolean renderShadow, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLinkWrapped(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color, int highlightedColor, double mouseX, double mouseY, boolean mouseClicked) {
     ...
     * @return <code>true</code> when the mouse if over this link and the left mouse button is down.
     */
    public static boolean drawLinkWrapped(@NotNull Font font, @NotNull GuiGraphics graphics, @NotNull ScreenCoordinate pos, @NotNull Component component, int color, int highlightedColor, boolean renderShadow, double mouseX, double mouseY, boolean mouseClicked) {
        int areaWidth = pos.getWidth();
