...
public class OverlayUtilities {
    ...
    public static void drawLine(@Nonnull OverlayProperties p, float fromX, float fromY, float fromZ, float toX,
        ...
        consumer.vertex(model, fromX, fromY, fromZ).color(red, green, blue, 1.0F).endVertex();
        consumer.vertex(model, toX, toY, toZ).color(red, green, blue, 1.0F).endVertex();
    ...
    public static class OverlayProperties {
        ...
        public OverlayProperties(@Nonnull Camera camera,
                                 @Nonnull PoseStack poseStack,
                                 @Nonnull RenderBuffers buffers) {
            this.camera = camera;
