...
public class ScreenCoordinate {
    ...
    public ScreenCoordinate(int x, int y, int width, int height, @NotNull Pivot pivot) {
     ...
     */
    public @NotNull ScreenCoordinate move(int offsetX, int offsetY) {
     ...
     */
    public @NotNull ScreenCoordinate withX(int value) {
        this.x = value;
        return this;
    }
     ...
     */
    public @NotNull ScreenCoordinate withY(int value) {
        this.y = value;
        return this;
    }
     ...
     */
    public @NotNull ScreenCoordinate withWidth(int value) {
        this.width = value;
        return this;
    }
     ...
     */
    public @NotNull ScreenCoordinate withHeight(int value) {
        this.height = value;
        return this;
    }
     ...
     */
    public @NotNull ScreenCoordinate withAlignment(@NotNull Pivot value) {
        this.pivot = value;
        return this;
    }
     ...
     */
    public @NotNull ScreenRect toScreenRect() {
        if (pivot == Pivot.CENTER) {
     ...
     */
    public static @NotNull ScreenCoordinate fromRect(@NotNull ScreenRect rect) {
