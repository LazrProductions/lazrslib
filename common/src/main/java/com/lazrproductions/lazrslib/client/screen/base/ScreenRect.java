...
public class ScreenRect {
     ...
     */
    public static @NotNull ScreenRect fromWidth(int x, int y, int width, int height) {
     ...
     */
    public static @NotNull ScreenRect fromWidthCentered(int x, int y, int width, int height) {
     ...
     */
    public @NotNull Vector2i getTopLeft() {
     ...
     */
    public @NotNull Vector2i getTopRight() {
     ...
     */
    public @NotNull Vector2i getBottomLeft() {
     ...
     */
    public @NotNull Vector2i getBottomRight() {
     ...
     */
    public @NotNull Vector2i getCenter() {
     ...
     */
    public @NotNull ScreenCoordinate toScreenCoordinate() {
     ...
     */
    public static @NotNull ScreenRect fromScreenCoordinate(@NotNull ScreenCoordinate coordinate) {
